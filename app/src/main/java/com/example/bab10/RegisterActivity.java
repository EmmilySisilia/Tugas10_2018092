...
import com.example.bab10.databinding.ActivityRegisterBinding;
...
//checking the validity of the Email
            ...
            if (!Patterns.EMAIL_ADDRESS.matcher(email).matches())7
            {
...
//checking the validity of the password
            ...
            if (password.length() < 6) {
                binding.signUppasswordEditText.setError("Minimum Length of a Password Should be");
                        binding.signUppasswordEditText.requestFocus();
                return;
            }
            ...
            if (rowid > 0) {
                Toast.makeText(getApplicationContext(), "Row " + rowid + "is successfully inserted",
                        Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(getApplicationContext(), "Row   " +
                        "inserted inserted ", Toast.LENGTH_SHORT).show();
            }
