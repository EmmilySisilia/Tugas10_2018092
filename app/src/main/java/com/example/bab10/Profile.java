...
import com.example.bab10.databinding.ProfileBinding;
...
public class Profile extends AppCompatActivity {
    ...
    @RequiresApi(api = Build.VERSION_CODES.M)
    private void requestStoragePermission() {requestPermissions(storagePermission, MY_STORAGE_REQUEST_CODE);
    }
...
//for view display
        binding.btnDisplay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Profile.this, com.example.bab10.DisplayData.class));
            }
        });
...
//edit hide and submit visible
                    ...
                    Intent a = new Intent(Profile.this, com.example.bab10.DisplayData.class);
                    startActivity(a);
                }
            }
        });
